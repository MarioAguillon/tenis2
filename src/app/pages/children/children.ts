...
export class ChildrenComponent {
  zapatillas = [
    { id: 1, nombre: 'Adidas Kids Red', precio: '150.000', img: 'img/ninos1.jpg' },
    ...
    { id: 4, nombre: 'Adidas SuperStart', precio: '130.000', img: 'img/ninos4.jpg' },
    { id: 5, nombre: 'Reebok Club C', precio: '175.000', img: 'img/ninos5.jpg' },
  ...
  irAPedidos(tenis: any) {
    this.cartService.agregarProducto(tenis); // Guarda el tenis
    this.router.navigate(['/pedidos']);      // Va a la página
  }
}